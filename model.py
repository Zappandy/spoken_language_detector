...
class CNNSpeechClassifier(nn.Module):
    ...
    def __init__(self, channel_inputs, num_channels1, num_channels2, kernel_size, stride, kernel_pool, padding, num_classes):
        num_channels3 = 64
        ...
        self.fc_layer = nn.Linear(num_channels1*16*215, num_classes)  # shape of cnn_layer 1 after convolution of image!
        #self.fc_layer = nn.Linear(num_channels1*31*430, num_classes)  # shape of cnn_layer 1 after convolution of image! old kernel_size 2 and no stride
